...
const processFile = () => {
    ...
    splitResult.forEach((line) => {
        ...
        winningNumbersArray.push(...currentWinningNumbers) // Collect all winning numbers
    ...
    const sumRandomWinningNumbers = () => {
        ...
        let shuffled = shuffleArray([...winningNumbersArray]) // Shuffle without modifying the original array
        let count = Math.floor(Math.random() * shuffled.length) + 1 // Pick 1 to max elements randomly
